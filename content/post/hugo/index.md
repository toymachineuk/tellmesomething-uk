...
##  Kubernetes: Less Technical Debt
 ...
 The Kubernetes team considered moving away from their customized WordPress and Ghost setup.

After discussing the idea with the engineering lead, it became clear that the developers also preferred not to maintain unnecessary databases and infrastructure. Some of the alternatives they evaluated lacked long-term support, while others relied on plugins that could easily become technical debt.

After migrating to Hugo, they gained:

    significantly faster site builds;

    built-in multilingual support;

    a simpler and more predictable infrastructure.
...
The Small Multiples team wanted to redesign their website from the ground up. They initially evaluated Gatsby but decided against it because integrating it with a CMS was more complicated than they wanted.

They eventually chose Hugo.

The biggest advantage was its modular architecture: the CMS, hosting, templates, and build pipeline are all independent of one another. Each component can be replaced without rebuilding the entire system.
